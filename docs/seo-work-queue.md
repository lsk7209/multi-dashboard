...
- 생성: 2026-06-13T04:22:47.450Z
- 대시보드 스냅샷: 2026-06-13T02:06:50.756Z
...
- 쿼리: 양육비 산정표 2026 / 클릭 1 / 노출 70 / CTR 1.4% / 순위 10.5
...
### 10. tennisfrens.com (tennisfrens.com)

- URL: https://tennisfrens.com/
- 유형: 하락 / high / T2 / codex_apply_after_site_checkout
- 핵심값: -59.7%
- 이유: GA4 사용자가 직전 7일 대비 -59.7% 변했습니다.
- 권장: 최근 발행, 색인, 유입 채널 변화를 먼저 확인하세요.
- 검증: 수정 후 7일 사용자, GSC 클릭, 상위 쿼리 CTR이 직전 갱신 대비 회복되는지 대시보드에서 비교합니다.
- 차단 조건: must compare top pages and channels before changing templates or links
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
...
- 쿼리: 란달루세 / 클릭 0 / 노출 18 / CTR 0.0% / 순위 8.4

작업 지시:

```text
Codex: tennisfrens.com(tennisfrens.com)의 최근 발행물, 유입 채널, 상위 쿼리/페이지 변동을 비교해 트래픽 하락 원인과 복구 작업을 우선순위로 제안해줘. 기준 정보: siteId=tennisfrens, url=https://tennisfrens.com/, gscSiteUrl=sc-domain:tennisfrens.com, sitemap=https://tennisfrens.com/sitemap-naver.xml, submitted=1165.
```

### 11. cartain.kr (cartain.kr)

- URL: https://cartain.kr/
- 유형: 하락 / high / T2 / codex_apply_after_site_checkout
- 핵심값: -41.1%
- 이유: GA4 사용자가 직전 7일 대비 -41.1% 변했습니다.
- 권장: 최근 발행, 색인, 유입 채널 변화를 먼저 확인하세요.
- 검증: 수정 후 7일 사용자, GSC 클릭, 상위 쿼리 CTR이 직전 갱신 대비 회복되는지 대시보드에서 비교합니다.
- 차단 조건: must compare top pages and channels before changing templates or links
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
- 리뷰 메모: 현재 신호는 작업 후보로 볼 수 있으나, 변경 전 상위 페이지와 쿼리 단위 근거를 한 번 더 확인하세요.
- 쿼리: 차량 유지비 계산 / 클릭 0 / 노출 11 / CTR 0.0% / 순위 7.2
...
### 13. 해몽드림 - GA4 (haemongdream.com)

- URL: https://haemongdream.com/
- 유형: 하락 / high / T2 / codex_apply_after_site_checkout
- 핵심값: -33.3%
- 이유: GSC 클릭이 직전 7일 대비 -33.3% 변했습니다.
- 권장: 상위 쿼리 순위와 CTR 하락 페이지를 점검하세요.
- 검증: 수정 후 7일 사용자, GSC 클릭, 상위 쿼리 CTR이 직전 갱신 대비 회복되는지 대시보드에서 비교합니다.
- 차단 조건: must compare top pages and channels before changing templates or links
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
- 리뷰 메모: GA4 사용자는 늘고 검색 클릭만 줄어든 케이스라 전체 트래픽 하락보다 검색 쿼리/CTR 하락으로 좁혀 보세요.
- 쿼리: 우산 없이 비 맞는 꿈 / 클릭 0 / 노출 12 / CTR 0.0% / 순위 7.7

작업 지시:

```text
Codex: 해몽드림 - GA4(haemongdream.com)의 최근 발행물, 유입 채널, 상위 쿼리/페이지 변동을 비교해 트래픽 하락 원인과 복구 작업을 우선순위로 제안해줘. 기준 정보: siteId=haemongdream, url=https://haemongdream.com/, gscSiteUrl=https://haemongdream.com/, sitemap=https://haemongdream.com/wp-sitemap.xml, submitted=8000.
```
...
### 15. todayshops.kr (todayshops.kr)

- URL: https://todayshops.kr/
- 유형: CTR 개선 / medium / T3 / content_handoff
- 핵심값: 2.4%
- 이유: 노출 41회 대비 CTR이 2.4%로 낮습니다.
...
### 16. texturb.com (texturb.com)

- URL: https://texturb.com/
- 유형: CTR 개선 / medium / T3 / content_handoff
- 핵심값: 2.2%
- 이유: 노출 225회 대비 CTR이 2.2%로 낮습니다.
- 권장: 제목과 메타 설명을 검색 의도에 맞춰 개선하세요.
- 검증: 개선 대상 페이지의 CTR과 평균 순위를 다음 GSC 갱신에서 기존 값과 비교합니다.
- 차단 조건: article titles, body text, headings, and in-body links require editorial handoff
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
...
### 18. 소프트와 - GA4 (softwa.kr)

- URL: https://softwa.kr/
- 유형: CTR 개선 / medium / T3 / content_handoff
- 핵심값: 1.9%
- 이유: 노출 215회 대비 CTR이 1.9%로 낮습니다.
- 권장: 제목과 메타 설명을 검색 의도에 맞춰 개선하세요.
- 검증: 개선 대상 페이지의 CTR과 평균 순위를 다음 GSC 갱신에서 기존 값과 비교합니다.
- 차단 조건: article titles, body text, headings, and in-body links require editorial handoff
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
...
### 19. tennisfrens.com (tennisfrens.com)

- URL: https://tennisfrens.com/
- 유형: CTR 개선 / medium / T3 / content_handoff
- 핵심값: 1.9%
- 이유: 노출 995회 대비 CTR이 1.9%로 낮습니다.
- 권장: 제목과 메타 설명을 검색 의도에 맞춰 개선하세요.
- 검증: 개선 대상 페이지의 CTR과 평균 순위를 다음 GSC 갱신에서 기존 값과 비교합니다.
- 차단 조건: article titles, body text, headings, and in-body links require editorial handoff
- GSC 진단: GSC 데이터가 수집되고 있습니다. 상위 쿼리와 URL 단위로 수정 후보를 좁혀 진행하세요.
...
```text
Codex: tennisfrens.com(tennisfrens.com)에서 노출은 있지만 CTR이 낮은 페이지의 제목, 메타 설명, 검색 의도 일치도를 개선할 후보를 찾아줘. 기준 정보: siteId=tennisfrens, url=https://tennisfrens.com/, gscSiteUrl=sc-domain:tennisfrens.com, sitemap=https://tennisfrens.com/sitemap-naver.xml, submitted=1165.
```
...
2. 급락 - tennisfrens.com (tennisfrens.com): GA4 사용자가 직전 7일 대비 크게 감소했습니다. / 최근 발행, 색인, 유입 채널 변경 여부를 확인하세요.
3. 급락 - bojo24.kr (bojo24.kr): GA4 사용자가 직전 7일 대비 크게 감소했습니다. / 최근 발행, 색인, 유입 채널 변경 여부를 확인하세요.
4. 급락 - ehon365.kr (ehon365.kr): GA4 사용자가 직전 7일 대비 크게 감소했습니다. / 최근 발행, 색인, 유입 채널 변경 여부를 확인하세요.
5. 급락 - spinkorea.kr (spinkorea.kr): GA4 사용자가 직전 7일 대비 크게 감소했습니다. / 최근 발행, 색인, 유입 채널 변경 여부를 확인하세요.
6. 급락 - cartain.kr (cartain.kr): GA4 사용자가 직전 7일 대비 크게 감소했습니다. / 최근 발행, 색인, 유입 채널 변경 여부를 확인하세요.
7. 급락 - 패스트잡 - GA4 (fastjob.kr): GSC 클릭이 직전 7일 대비 크게 감소했습니다. / 상위 쿼리와 CTR 하락 페이지를 점검하세요.
8. 급락 - 해몽드림 - GA4 (haemongdream.com): GSC 클릭이 직전 7일 대비 크게 감소했습니다. / 상위 쿼리와 CTR 하락 페이지를 점검하세요.
9. 급락 - picklefriend.kr (picklefriend.kr): GSC 클릭이 직전 7일 대비 크게 감소했습니다. / 상위 쿼리와 CTR 하락 페이지를 점검하세요.
10. 사이트맵 - 강사자판기 (kang4.com): GSC sitemap 마지막 수집일이 5일 전입니다. / Search Console에 sitemap을 재제출하고 sitemap lastmod와 robots.txt Sitemap 라인을 확인하세요.
11. 사이트맵 - insupang - GA4 (insupang.com): GSC sitemap 마지막 수집일이 5일 전입니다. / Search Console에 sitemap을 재제출하고 sitemap lastmod와 robots.txt Sitemap 라인을 확인하세요.
12. 사이트맵 - 이에스지요 - GA4 (esgyo.kr): GSC sitemap 마지막 수집일이 5일 전입니다. / Search Console에 sitemap을 재제출하고 sitemap lastmod와 robots.txt Sitemap 라인을 확인하세요.
