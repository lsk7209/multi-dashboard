...
- Path: `data\dashboard-ui-smoke-2026-07-08.json`
- Exists: `true`
- Status: `current`
- Expected stats snapshot: `2026-07-07T15:47:44.194Z`
- UI smoke stats snapshot: `2026-07-07T15:47:44.194Z`
- Artifact generated at: `2026-07-07T15:47:56.470Z`
...
|---|---|---:|---|---:|---:|---:|---:|---:|
| `site_stats_snapshot` | `data\site-stats.json` | `true` | `2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `site_stats_history` | `data\history\2026-07-07.json` | `true` | `2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `fleet_optimization_chain` | `data\fleet-optimization-chain-2026-07-08.json` | `true` | `2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `gsc_permission_audit` | `data\gsc-permission-audit-2026-07-08.json` | `true` | `data/site-stats.json generatedAt=2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `adsense_remediation_queue` | `data\adsense-remediation-queue-2026-07-08.json` | `true` | `data/site-stats.json generatedAt=2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `vercel_api_data_inventory` | `data\vercel-api-data-sites.json` | `true` | `2026-07-07T15:47:48.999Z` | `false` | `false` | `false` | `false` | `false` |
| `fleet_optimization_plan` | `data\fleet-optimization-plan-2026-07-08.json` | `true` | `2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
| `t3_title_content_handoff` | `data\t3-title-content-handoff-2026-07-08.json` | `true` | `2026-07-07T15:47:44.194Z` | `false` | `false` | `false` | `false` | `false` |
