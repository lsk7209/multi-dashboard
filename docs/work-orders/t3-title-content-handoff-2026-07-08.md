...
| `dogswhere.com` | 7 | `title_handoff` | 855 impr / 14 clicks / 1.64% CTR / pos 13.19 | 1382 | `missing` | `D:\web\dogswherecom` |
| `petinsuer.com` | 8, 11 | `title_handoff`, `content_handoff` | 1202 impr / 18 clicks / 1.50% CTR / pos 9.75 | 88 | `missing` | `D:\web\petinsuercom` |
| `fastjob.kr` | 10 | `title_handoff` | 836 impr / 13 clicks / 1.56% CTR / pos 14.74 | 685 | `aso 키워드 이해 및 분석` (10 impr, pos 59.60) | `D:\web\fastjob` |
| `ehon365.kr` | 12 | `title_handoff` | 767 impr / 16 clicks / 2.09% CTR / pos 14.26 | 651 | `missing` | `D:\web\ehon365\temp_clone` |
| `dogspang.kr` | 13, 15 | `title_handoff`, `content_handoff` | 997 impr / 17 clicks / 1.71% CTR / pos 9.95 | 90 | `강아지 발바닥 각화증` (18 impr, pos 7.72) | `D:\web\dogspangkr` |
| `homeimer.com` | 14 | `content_handoff` | 1084 impr / 0 clicks / 0.00% CTR / pos 66.77 | 10 | `missing` | `D:\web\homeimercom` |
| `today2424.kr` | 16 | `content_handoff` | 784 impr / 27 clicks / 3.44% CTR / pos 9.51 | 96 | `월세 계약해지 통보 문자 예시` (20 impr, pos 5.80) | `D:\web\today2424\2424` |
| `nexttech7.com` | 17, 19 | `title_handoff`, `content_handoff` | 602 impr / 13 clicks / 2.16% CTR / pos 12.07 | 59 | `missing` | `D:\web\nexttech7com` |
| `legalser.com` | 20 | `content_handoff` | 547 impr / 1 clicks / 0.18% CTR / pos 67.37 | 17 | `missing` | `D:\web\legalsercom` |
