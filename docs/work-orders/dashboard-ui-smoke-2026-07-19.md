# Dashboard UI Smoke - 2026-07-19

This is a local browser-rendered smoke artifact. It does not mutate production or external systems.

## Summary

- URL: `http://127.0.0.1:3012/?actionabilityMode=local-evidence&actionabilityToken=redacted`
...
- Blocking: `none`
- Maintenance: `skipped_refresh_failed:adsense_collector:transient_error:1`
...
- Fleet chain: `data/fleet-optimization-chain-2026-07-19.json`
- GSC audit: `data/gsc-permission-audit-2026-07-19.json`
- GSC work order: `docs/work-orders/gsc-permission-audit-2026-07-19.md`
