# T3 Title/Content Handoff - 2026-07-10T08:51:36.848Z
...
|---|---:|---|---:|---:|---|---|
| `tennisfrens.com` | 1 | `title_handoff` | 11684 impr / 114 clicks / 0.98% CTR / pos 10.01 | 1439 | `ntrp 테스트` (12 impr, pos 2.50)<br>`아르튀르 랭데르크네슈` (531 impr, pos 10.20)<br>`이알라` (65 impr, pos 10.86) | `D:\web\tennisfrens` |
...
| `dogspang.kr` | 10, 13 | `title_handoff`, `content_handoff` | 1084 impr / 18 clicks / 1.66% CTR / pos 10.01 | 87 | `강아지 발바닥 각화증` (19 impr, pos 7.74) | `D:\web\dogspangkr` |
