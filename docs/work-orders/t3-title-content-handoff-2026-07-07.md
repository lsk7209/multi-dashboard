...
|---|---:|---|---:|---:|---|---|
| `tennisfrens.com` | 1 | `title_handoff` | 8378 impr / 114 clicks / 1.36% CTR / pos 10.49 | 1524 | `ntrp 테스트` (12 impr, pos 1.75)<br>`아르튀르 랭데르크네슈` (762 impr, pos 10.33)<br>`알렉산더 블록스` (363 impr, pos 10.37) | `D:\web\tennisfrens` |
| `cartain.kr` | 2 | `title_handoff` | 2611 impr / 41 clicks / 1.57% CTR / pos 9.85 | 932 | `2026년 신차 출시 일정` (26 impr, pos 6.88) | `D:\web\cartainkr` |
| `estat.kr` | 3, 4 | `title_handoff`, `content_handoff` | 2509 impr / 17 clicks / 0.68% CTR / pos 7.97 | 63 | `missing` | `D:\web\estatkr` |
| `gong365.kr` | 5, 6 | `title_handoff`, `content_handoff` | 1883 impr / 24 clicks / 1.27% CTR / pos 8.29 | 56 | `전남 2026 기업 지원사업 공고` (15 impr, pos 7.00) | `D:\web\gong365kr` |
| `dogswhere.com` | 7 | `title_handoff` | 883 impr / 15 clicks / 1.70% CTR / pos 13.08 | 1398 | `강아지 맡길 곳` (11 impr, pos 34.27)<br>`부산 지하철 근처 애견 유치원` (11 impr, pos 40.27) | `D:\web\dogswherecom` |
| `petinsuer.com` | 8, 11 | `title_handoff`, `content_handoff` | 1238 impr / 18 clicks / 1.45% CTR / pos 9.82 | 87 | `missing` | `D:\web\petinsuercom` |
| `fastjob.kr` | 10 | `title_handoff` | 883 impr / 14 clicks / 1.59% CTR / pos 14.76 | 684 | `aso 키워드 이해 및 분석` (10 impr, pos 59.60) | `D:\web\fastjob` |
| `ehon365.kr` | 12 | `title_handoff` | 783 impr / 17 clicks / 2.17% CTR / pos 14.22 | 661 | `missing` | `D:\web\ehon365\temp_clone` |
| `dogspang.kr` | 13, 15 | `title_handoff`, `content_handoff` | 1022 impr / 17 clicks / 1.66% CTR / pos 9.95 | 90 | `강아지 발바닥 각화증` (20 impr, pos 7.65) | `D:\web\dogspangkr` |
...
| `petinsuer.com` | `wordpress` | `https://petinsuer.com/sitemap_index.xml`, warnings=0, errors=0 | `ok` | `ok` | Title + content workflow; do not directly edit live titles or article bodies from this handoff. |
