...
- Fleet chain: `data/fleet-optimization-chain-2026-07-27.json`
- GSC audit: `data/gsc-permission-audit-2026-07-27.json`
- GSC work order: `docs/work-orders/gsc-permission-audit-2026-07-27.md`
