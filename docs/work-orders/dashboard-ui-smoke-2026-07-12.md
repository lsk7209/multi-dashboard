# Dashboard UI Smoke - 2026-07-12

This is a local browser-rendered smoke artifact. It does not mutate production or external systems.

## Summary

- URL: `http://127.0.0.1:3100/?actionabilityMode=local-evidence&actionabilityToken=redacted`
...
- Fleet chain: `data/fleet-optimization-chain-2026-07-12.json`
- GSC audit: `data/gsc-permission-audit-2026-07-12.json`
- GSC work order: `docs/work-orders/gsc-permission-audit-2026-07-12.md`
