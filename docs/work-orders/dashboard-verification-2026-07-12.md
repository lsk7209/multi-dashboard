...
- Path: `data\dashboard-ui-smoke-2026-07-12.json`
- Exists: `true`
- Status: `current`
- Expected stats snapshot: `2026-07-11T16:18:45.043Z`
- UI smoke stats snapshot: `2026-07-11T16:18:45.043Z`
- Artifact generated at: `2026-07-11T16:26:06.370Z`
...
|---|---|---:|---|---:|---:|---:|---:|---:|
| `site_stats_snapshot` | `data\site-stats.json` | `true` | `2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `site_stats_history` | `data\history\2026-07-11.json` | `true` | `2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `fleet_optimization_chain` | `data\fleet-optimization-chain-2026-07-12.json` | `true` | `2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `gsc_permission_audit` | `data\gsc-permission-audit-2026-07-12.json` | `true` | `data/site-stats.json generatedAt=2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `adsense_remediation_queue` | `data\adsense-remediation-queue-2026-07-12.json` | `true` | `data/site-stats.json generatedAt=2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `vercel_api_data_inventory` | `data\vercel-api-data-sites.json` | `true` | `2026-07-10T22:58:37.317Z` | `false` | `false` | `false` | `false` | `false` |
| `fleet_optimization_plan` | `data\fleet-optimization-plan-2026-07-12.json` | `true` | `2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
| `t3_title_content_handoff` | `data\t3-title-content-handoff-2026-07-12.json` | `true` | `2026-07-11T16:18:45.043Z` | `false` | `false` | `false` | `false` | `false` |
