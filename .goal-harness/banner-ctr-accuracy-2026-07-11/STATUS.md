...
Remaining: Resolve Notebook's external-script optimization, which removes the loader even though the banner marker is present.
Blocked: No global blocker. Cartain, Pregnancy, Yungyang, and Dogswhere are deployed with public measurement markers; Cartain's real-browser impression event returned 200 with the current loader.
