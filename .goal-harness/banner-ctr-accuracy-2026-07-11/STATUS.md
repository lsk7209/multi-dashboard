...
Remaining: Repair sites that have not yet exposed the marker after their deployment/cache cycle, and review the two untracked app banner components (`pregnancy-ehon365`, `yungyanggogo`) before committing them.
Blocked: No global blocker. Two untracked app components remain deliberately preserved.
